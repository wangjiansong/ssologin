...
public class ThirdAttributeDao extends StubPersonAttributeDao {  
  
    @NotNull
    private JdbcTemplate jdbcTempthird;
    ...
    public IPersonAttributes getPerson(String uid) {  
		...
		final Map<String, Object> values = jdbcTempthird.queryForMap(sql, new Object[] { uid });
...
//			map.put("roles", Collections.singletonList((Object) "admin"));
    ...
    public JdbcTemplate getJdbcTemplate() {  
        return jdbcTempthird;  
    }  
  
    public void setJdbcTemplate(JdbcTemplate jdbcTempthird) {  
        this.jdbcTempthird = jdbcTempthird;  
    } 
}  